...
let world = hitableList(list: [
    ...
    sphere(center: vec3(1, 0, -1), radius: 0.5, material: metal(0.8, 0.6, 0.2, roughness: 1.0)),
    sphere(center: vec3(-1, 0, -1), radius: 0.5, material: metal(0.8, 0.8, 0.8, roughness: 0.3)),
    ])
